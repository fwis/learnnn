...
input_data_path = r'D:\VScodeProjects\learnnn\T3\Frame\test\83_data.pt'
...
aop_true = torch.load(r'D:\VScodeProjects\learnnn\T3\Frame\test\83_aop.pt').cpu().unsqueeze(0).unsqueeze(0)
dolp_true = torch.load(r'D:\VScodeProjects\learnnn\T3\Frame\test\83_dolp.pt').cpu().unsqueeze(0).unsqueeze(0)
s0_true = torch.load(r'D:\VScodeProjects\learnnn\T3\Frame\test\83_s0.pt').cpu().unsqueeze(0).unsqueeze(0)/2
